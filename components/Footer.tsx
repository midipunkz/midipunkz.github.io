    ...
    <div className="mx-auto max-w-screen-xl">
        <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
                <a href="https://midipunkz.com" className="flex items-center">
                    <Logo/>
                    {/* <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">MiDiPunkz</span> */}
                </a>
            </div>
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Metaverses</h2>
                    <ul className="text-gray-600 dark:text-gray-400">
                        <li className="mb-4">
                            <a href="https://www.spatial.io/s/MiDiPunkz-DJ-Eden-64397bcfc5837fcb1d20aaeb?share=2051843384976615882" className="hover:underline">Spatial</a>
                        </li>
                        <li>
                            <a href="https://oncyber.com/midipunkz" className="hover:underline">OnCyber</a>
                        </li>
                    </ul>
                </div>
                <div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://midipunkz.com" className="hover:underline">MiDiPunkz</a>. All Rights Reserved.
            </span>
            <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                ...
                <a href="https://www.instagram.com/midipunkz/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                ...
                <a href="https://twitter.com/midipunkz" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
